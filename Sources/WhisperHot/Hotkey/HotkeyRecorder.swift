...
extension Notification.Name {
    ...
    static let whisperHotHotkeyRecorderDidArm = Notification.Name("WhisperHot.hotkeyRecorderDidArm")
    ...
    static let whisperHotHotkeyRecorderDidDisarm = Notification.Name("WhisperHot.hotkeyRecorderDidDisarm")
    ...
    static let whisperHotSettingsWillClose = Notification.Name("WhisperHot.settingsWillClose")
}
...
struct HotkeyRecorderView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .whisperHotSettingsWillClose)) { _ in
            stopMonitoring()
        }
    }
    ...
    private func startMonitoring() {
        ...
        NotificationCenter.default.post(
            name: .whisperHotHotkeyRecorderDidArm,
            object: nil
        )
    }
    ...
    private func stopMonitoring() {
        ...
        rejectionFlash = nil
        NotificationCenter.default.post(
            name: .whisperHotHotkeyRecorderDidDisarm,
            object: nil
        )
    }
