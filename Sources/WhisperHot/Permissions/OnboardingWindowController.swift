...
final class OnboardingWindowController: NSObject, NSWindowDelegate {
    static let hasShownKey = "WhisperHot.hasShownOnboarding"
    ...
    private func buildWindow() {
        ...
        newWindow.title = "Welcome to WhisperHot"
        ...
        let titleLabel = NSTextField(labelWithString: "WhisperHot needs two permissions")
        ...
        let footer = NSTextField(
            labelWithString: "You can re-open this window from the WhisperHot menu at any time."
        )
    ...
    private func refreshStates() {
        ...
        if axGranted {
            ...
            axStatusLabel?.stringValue = "Not granted — enable WhisperHot in System Settings"
    ...
    func windowWillClose(_ notification: Notification) {
        ...
        // Only restore the previously-focused app if WhisperHot is still the
