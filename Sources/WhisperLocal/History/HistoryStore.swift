...
/// `~/Library/Application Support/WhisperLocal/history.bin` and encrypted
...
final class HistoryStore {
    ...
    private func resolveStorageDirectory() throws -> URL {
        ...
        let dir = base.appendingPathComponent("WhisperLocal", isDirectory: true)
    ...
    private func persist() throws {
        ...
        do {
            ...
            guard let combined = sealed.combined else {
                throw NSError(
                    domain: "WhisperLocal.HistoryStore",
                    code: -2,
