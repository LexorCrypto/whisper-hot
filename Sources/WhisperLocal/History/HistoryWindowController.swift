...
extension Notification.Name {
    ...
    static let whisperLocalHistoryWillShow = Notification.Name("WhisperLocal.historyWillShow")
}
...
final class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    func show() {
        ...
        NotificationCenter.default.post(name: .whisperLocalHistoryWillShow, object: nil)
    }
...
private struct HistoryView: View {
    ...
    var body: some View {
        ...
        .onAppear { reload() }
        .onReceive(NotificationCenter.default.publisher(for: .whisperLocalHistoryWillShow)) { _ in
            reload()
        }
    }
