...
/// current bundled app as a login item so WhisperLocal launches when the
/// user signs in.
///
...
enum LaunchAtLoginController {
    ...
    static var statusDescription: String {
        ...
        case .notFound:
            return "Not found — macOS cannot manage this copy of WhisperLocal as a login item. Move the app to a stable install path (for example /Applications) and try again."
        @unknown default:
