...
(режим `hybrid` — GitHub Issues источник правды по задачам): роутер может создавать здесь
Issues. Posture роутера — MVP (доверенная машина + GitHub-логин; секьюрный слой ADR-0027
снят с плана, решение владельца 2026-06-16).
