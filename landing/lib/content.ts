...
export const FEATURES: Feature[] = [
  ...
  {
    icon: "waveform",
    title: "2 стиля индикатора",
    text: "Маленький и средний — живая RMS-волна с фирменным градиентом, таймер записи и куда попадёт текст: активное приложение при авто-вставке, иначе буфер обмена.",
  },
  {
    icon: "dictionary",
