...
записи (минимальный / средний), контекстный роутинг по
...
- Плавающий индикатор показывает время записи, живой RMS-уровень и куда
  попадёт распознанный текст (→ активное приложение при авто-вставке,
  иначе буфер обмена). Два стиля: маленький и средний. Переключается в
  настройках.
...
- **Recording** — язык (auto + 15 языков), auto-paste в активное
  приложение, звуковые chimes, стиль индикатора (маленький / средний),
